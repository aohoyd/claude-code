...
**Architecture:** JWT-based auth with bcrypt password hashing, Redis session store

**Tech Stack:** Python, FastAPI, PyJWT, bcrypt, Redis
...
Run: `pytest tests/models/test_user.py::test_user_model_has_required_fields -v`
